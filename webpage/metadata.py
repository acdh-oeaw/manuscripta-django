...
PROJECT_METADATA = {
    ...
    'subtitle': 'Mittelalterliche Handschriften in Österreich ',
    'description': 'A prototype Django implementation of manuscripta.at',
    'github': 'https://github.com/acdh-oeaw/manuscripta-django',
